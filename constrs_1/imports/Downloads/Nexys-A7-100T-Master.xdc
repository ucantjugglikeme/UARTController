...
## Clock signal
set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN E3 } [get_ports { CLK }]; # IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { BTN_0 }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { BTN_1 }]; #IO_L10N_T1_D15_14 Sch=btnr
